...
const file_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x12user/v1/user.proto\x12\auser.v1\x1a\x1cgoogle/api/annotations.proto\"\x1d\n" +
...
var file_user_v1_user_proto_goTypes = []any{
	(*InfoRequest)(nil), // 0: user.v1.InfoRequest
	(*InfoReply)(nil),   // 1: user.v1.InfoReply
}
var file_user_v1_user_proto_depIdxs = []int32{
	0, // 0: user.v1.User.Info:input_type -> user.v1.InfoRequest
	1, // 1: user.v1.User.Info:output_type -> user.v1.InfoReply
